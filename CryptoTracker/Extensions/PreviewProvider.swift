...
class DeveloperPreview {
    ...
    let stat1: StatisticModel = StatisticModel(title: "Market Cap", value: "$12.5Bn", percentageChange: 25.34)
    let stat2: StatisticModel = StatisticModel(title: "Total Value", value: "$1.23Tn")
    let stat3: StatisticModel = StatisticModel(title: "Portfolio Value", value: "$50.4k", percentageChange: -12.34)
